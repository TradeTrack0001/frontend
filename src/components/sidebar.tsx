        ...
        <div className="flex flex-col h-full">
            ...
            <ul className="flex flex-col space-y-4">
              ...
              <li>
                <button
                  ...
                  className="flex items-center w-full p-4 text-left rounded hover:bg-blue-800" // Increased padding
                >
              ...
              <li>
                <button
                  ...
                  className="flex items-center w-full p-4 text-left rounded hover:bg-blue-800" // Increased padding
                >
                  <FontAwesomeIcon icon={faSignInAlt} className="mr-3" /> Check
                  in {/* Increased margin */}
                </button>
              </li>
              {/* <li>
          ...
          <div className="mt-auto">
            <button
              ...
              className="flex items-center w-full p-4 mb-2 text-white rounded-md cursor-pointer hover:bg-red-700" // Increased padding
            >
              <FontAwesomeIcon
                icon={faPersonWalkingDashedLineArrowRight}
                className="mr-3 scale-x-[-1]"
              />{" "}
              LOG OUT {/* Increased margin */}
            </button>
          </div>
        </div>
      </div>
